...
Description: IZ-Calender is a user-friendly callender view of events that can be used as a widget and/or page. Version 3.0 provides a clean admin interface (including dashboard quick inserts) which enables you to add, update, delete and manage events. 
Author: Paul Cilliers
Version: 3.0
Author URI: http://www.intisul.co.za
License: GPLv2
*/
global $wpdb;
